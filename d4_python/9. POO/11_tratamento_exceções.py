...
class Projeto:
    ...
    def procurar(self, descricao):
        try:
            # bloco de codigo que pode vim a gerar erro
...
def main():
    ...
    casa += TarefaRecorrente('trocas lençóis', datetime.now(), 7)
    casa.procurar('trocas lençóis').concluir()
    print(casa)
    # tratamento de erro
    try:
        casa.procurar('Lavar prato - ERRO').concluir()
        # pode ser tratado como erro (opcional)
